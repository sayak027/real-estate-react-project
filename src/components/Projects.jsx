  ...
  return (
    <motion.div 
      ...
      className='container mx-auto py-4 px-6 pt-20 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
        <h1 className='text-2xl sm:text-4xl font-bold text-center mb-2'>Projects 
            <span className='underline underline-offset-4 under decoration-1 font-light'> Completed</span>
        </h1>
